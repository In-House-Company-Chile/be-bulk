...
class CheckLastSentences {
    ...
    static async create(HORARIO_BLOQUEADO, PAUSA_CADA_PETICIONES, PAUSA_MINUTOS, MAX_ID, LOG_DIR, dbName, dbCollection, namespace) {
        return await new CheckLastSentences(HORARIO_BLOQUEADO, PAUSA_CADA_PETICIONES, PAUSA_MINUTOS, MAX_ID, LOG_DIR, dbName, dbCollection, namespace).check()
    }
...
module.exports = CheckLastSentences
...
const PARALLELIZATION_CONFIG = {
  ...
  EMBEDDING_API_URL: process.env.EMBEDDING_API_URL || 'http://localhost:11440/embed',
  ...
  return {
    logBatchPerformance: (batchSize, batchNumber, totalBatches, extraMetrics = {}) => {
      ...
      if (extraMetrics.embeddingTime) totalEmbeddingTime += extraMetrics.embeddingTime;
              if (extraMetrics.qdrantTime) totalQdrantTime += extraMetrics.qdrantTime;
      ...
      if (totalEmbeddingTime > 0) {
        ...
        console.log(`   🧠 Tiempo promedio embeddings: ${avgEmbeddingTime.toFixed(0)}ms/doc`);
          ...
          if (totalQdrantTime > 0) {
      const avgQdrantTime = totalQdrantTime / totalProcessed;
    ...
    getFinalStats: (totalProcessed, totalErrors, totalDuplicates) => {
      ...
      return {
        ...
        avgQdrantTime: totalProcessed > 0 ? (totalQdrantTime / totalProcessed).toFixed(0) : 0
      };
    }
  };
}
...
async function indexarQdrant(sentenciasDir, vectorizedDir) {
  try {
    ...
    console.log(`\n🚀 INICIANDO INDEXACIÓN ULTRA OPTIMIZADA`);
    ...
    const collectionName = 'jurisprudencia';
    ...
    // TODO: Implementar sincronización de caché con Qdrant
    // await cacheManager.syncWithQdrant(qdrantUrl, collectionName);
...
// Ejecutar
// indexarQdrant('C:/Users/ljutr/Desktop/sentencias/suprema/sentencias', 'C:/Users/ljutr/Desktop/sentencias/suprema/vectorized');
indexarQdrant('C:/Users/ljutr/Desktop/sentencias/sentencias', 'C:/Users/ljutr/Desktop/sentencias/vectorized');
// indexarQdrant('sentencias', 'vectorized');
